...
def gameLoop():
    ...
    while not exitGame:
        if gameOver:
            ...
            # Increase the game speed based on the distance
            if dist % 10 == 0:  # Increase speed every 10 distance units
                stripSpeed = baseStripSpeed + dist // 10
            ...
            for i in range(len(obstacleXY)):
                obstacleXY[i][1] += obstacleSpeed[i] + stripSpeed - baseStripSpeed
